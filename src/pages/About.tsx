      ...
      <main className="flex-1 container py-12">
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <div className="space-y-4">
            <p>
              SkillBridge was created to solve a common problem in educational institutions: 
              connecting people with ideas to those with the skills to bring them to life. 
              Our platform enables students, faculty, and staff to collaborate on projects 
              by matching skills, interests, and expertise.
            </p>
            ...
            <p>
              ...
              Our mission is to foster innovation, learning, and collaboration within the academic community.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><strong>Email:</strong> moturimonish@gmail.com</li>
              <li><strong>Phone:</strong> 6303636530</li>
            </ul>
          </div>
        </div>
      </main>
